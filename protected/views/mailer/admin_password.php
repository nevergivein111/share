                        ...
                        <table border="0" cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                <td align="center" valign="top">
                                    <p style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#61a8e2; font-size:20px; margin-top:40px; text-align:center;">You're invited with shareview.com</p>
                                    <p style="font-family:Arial, Helvetica, sans-serif; color:#808284; font-size:13px; text-align:center; margin-bottom:40px;">Your account is ready, you just need to click on the button below to enter a password.<br />It only takes a few seconds. </p>
                                    <a href="<?php echo $link;?>">
                                        <img src="<?php echo Yii::app()->getBaseUrl(true); ?>/mailer_img/set_password_btn.png" alt="" />
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" valign="top">
                                    ...
                                    <a href="#" style="font-family:Arial, Helvetica, sans-serif; color:#61a8e2; font-size:13px; text-align:center; text-decoration:underline;"><?php echo $link;?></a>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" valign="top">
