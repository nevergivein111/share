...
<!--	<div class="hSeprator"></div>
	<div class="brand_wrapper" data-type="<?php // echo $filterValue->name; ?>">
		<h4><?php // echo $filterValue->name; ?></h4>
		<?php // foreach ($filterValue->getList($filter->inputs) as $attr): ?>
		<?php
//		$product_count = $attr->getCount($filter, $filterValue);
...
//		if ($product_count > 0):?>
			<div class="filter <?php // echo ($key > 4) ? 'filter_none' : null?>">
                                <span>
                                        <label>
                                                <?php
//                                                echo $form->checkBox($filter, "inputs[" . $filterValue->unique->name . "][$attr->value]", array(
//                                                'class' => 'checkbox_product_page',
//                                                'data-type' => $filterValue->unique->name,
//                                                'data-value' => "$attr->value",
//                                                )); 
                                                ?>
                                                <p class="filter_our"><?php // echo $name; ?></p>
                                        </label>
                                </span>
			</div>
			<?php // $key++; ?>
